...
export const roleApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    addNewUser: builder.mutation({
      query: (formData) => {
        const { user_name, email, name, contact_no, profile_image, address, roles, designation_id,  contactPersonMobile, user_description, } = formData;
        ...
        form.append('designation_id', designation_id);
        form.append('contact_person', contactPersonMobile);
    ...
    statuschangeUser: builder.mutation({
      query: ({ ID, is_user_blocked }) => ({
        url: `changeuserstatus/${ID}`,
        method: "PUT",
        body: { is_user_blocked },
        credentials: "include",
      }),
      invalidatesTags: [TAGS.USERS],
    }),
