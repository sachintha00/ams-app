...
export const roleApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    requestApprove: builder.mutation({
      query: ({ request_id, workflow_node_id, workflow_id, requisition_id, approver_comment, designaion_user_id }) => ({
        url: "workflow/request-approve",
        method: "POST",
        body: { request_id, workflow_node_id, workflow_id, requisition_id, approver_comment, designaion_user_id },
        credentials: "include",
      }),
