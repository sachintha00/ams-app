...
export default function users() {
    ...
    const [assetReqId, setAssetReqId] = useState('');
    ...
    const [selectedRadioBtnOption, setRadioBtnOption] = useState('');
    ...
    useEffect(() => {
        ...
        if (savedFormData) {
            ...
            setRadioBtnOption(savedFormData.selectedRadioBtnOption || '');
            ...
            // setSelectedValues(savedFormData.selectedValues || '');
    ...
    const handleChangeSetQuantity = (e) => {
        const newValue = e.target.value;
    ...
    const handleChangeSetbusinessperpose = (e) => {
        const newValue = e.target.value;
        setQuantity(newValue);
        saveFormDataToLocalStorage({
        itemName,
    ...
    // Check if Item Name and Priority are not empty
        ...
        if (editIndex !== null) {
            ...
            updatedItems[editIndex] = { itemName, assesttype, quantity, budget, businessperpose, selectedRadioBtnOption, periodStatus, periodFrom, periodTo, period, availabiityType, priority, requiredDate, reason, businessImpact, selectedValues, files, itemDetails, maintenanceKpi, serviceSupportKpi, consumablesKPI };
            setItems(updatedItems);
            // Reset editIndex
            setEditIndex(null);
        } else {
            // Add new item to the list
            const newItem = { itemName, assesttype, quantity, budget, businessperpose, selectedRadioBtnOption, periodStatus, periodFrom, periodTo, period, availabiityType, priority, requiredDate, reason, businessImpact, selectedValues, files, itemDetails, maintenanceKpi, serviceSupportKpi, consumablesKPI };
    ...
    const handleEditItem = (index) => {
      ...
      setRadioBtnOption(itemToEdit.selectedRadioBtnOption);
      ...
      setSelectedValues(itemToEdit.selectedValues);
                        ...
                        {isOpenAddForm && (
                            <div className="fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center" style={{ marginLeft:0 }}>
                                ...
                                <div className="bg-white w-4/5 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                    ...
                                    {/* Modal body */}
                                    <form className="px-2 pt-2 overflow-y-scroll h-[500px]" style={{ scrollbarWidth: '2px', scrollbarColor:'#888'}} onSubmit={submitForm} encType="multipart/form-data">
                                        ...
                                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                                            <div className='flex'>
                                                ...
                                                <span className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                    {assetReqId}
                                                    <input type="hidden" value={assetReqId} />
                                                </span>
                                            </div>
                                        ...
                                        <div className="grid gap-6 mb-6">
                                                ...
                                                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                    ...
                                                    {items.map((item, index) => (
                                                        <tr key={index} className='odd:bg-white odd:dark:bg-[#1e1e1e] even:bg-gray-50 even:dark:bg-[#3c4042] border-b dark:border-gray-700'>
                                                            ...
                                                            <td className="px-6 py-4">{item.selectedRadioBtnOption}</td>
                                            ...
                                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    type="text" 
                                                    value={quantity} 
                                                    onChange={handleChangeSetQuantity}  
                                                    placeholder="Item Name" 
                                                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        type="text"
                                                        id="user_name"
                                                        onChange={handleChangeSetbusinessperpose} 
                                                        name="user_name"
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-[#3c4042] dark:border-gray-500 dark:text-white">
                                                        ...
                                                        <div className="flex items-center ps-3">
                                                            ...
                                                            checked={selectedRadioBtnOption === 'upgrade the existing one'} 
                                                            onChange={handleRadioBtnOptionChange}
                                                            name="list-radio"
                                                        ...
                                                        <div className="flex items-center ps-3">
                                                            ...
                                                            checked={selectedRadioBtnOption === 'purchase a new'} 
                                                            onChange={handleRadioBtnOptionChange}
                                                            name="list-radio"
                                                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                                            />
                                            ...
                                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                                                ...
                                                {periodStatus === 'long' || periodStatus === 'short' ? (
                                            ...
                                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                                                <div>
                                                    ...
                                                    onChange={(e) => setAvailabiityType(e.target.value)}
                                                    >
                                                    ...
                                                    {itemDetails.map((itemDetail, index) => (
                                                        <div key={index} className="grid gap-6 mb-4 md:grid-cols-3">
                                                            <input 
                                                                ...
                                                                onChange={(e) => {
                                                                const updatedItemDetails = [...itemDetails];
                                                                updatedItemDetails[index] = { ...updatedItemDetails[index], type: e.target.value };
                                                                setItemDetails(updatedItemDetails);
                                                                }} 
                                                            ...
                                                            <input 
                                                                ...
                                                                onChange={(e) => {
                                                                const updatedItemDetails = [...itemDetails];
                                                                updatedItemDetails[index] = { ...updatedItemDetails[index], details: e.target.value };
                                                                setItemDetails(updatedItemDetails);
                                                                }} 
                                                                placeholder="Details" 
                                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ...
                                                    {maintenanceKpi.map((maintenancekpi, index) => (
                                                        <div key={index} className="grid gap-6 mb-4 md:grid-cols-3">
                                                            <input 
                                                                ...
                                                                onChange={(e) => {
                                                                const updatedMaintenanceKpi = [...maintenanceKpi];
                                                                updatedMaintenanceKpi[index] = { ...updatedMaintenanceKpi[index], details: e.target.value };
                                                                setMaintenanceKpi(updatedMaintenanceKpi);
                                                                }} 
                                                                placeholder="Details" 
                                                    ...
                                                    {serviceSupportKpi.map((servicesupportkpi, index) => (
                                                        <div key={index} className="grid gap-6 mb-4 md:grid-cols-2">
                                                            <input 
                                                                ...
                                                                onChange={(e) => {
                                                                const updatedServiceSupportKpi = [...serviceSupportKpi];
                                                                updatedServiceSupportKpi[index] = { ...updatedServiceSupportKpi[index], details: e.target.value };
                                                                setServiceSupportKpi(updatedServiceSupportKpi);
                                                                }} 
                                                                placeholder="Details" 
                                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                    ...
                                                    {consumablesKPI.map((consumableskpi, index) => (
                                                        <div key={index} className="grid gap-6 mb-4 md:grid-cols-2">
                                                            <input 
                                                                ...
                                                                onChange={(e) => {
                                                                const updatedConsumablesKPI = [...consumablesKPI];
                                                                updatedConsumablesKPI[index] = { ...updatedConsumablesKPI[index], details: e.target.value };
                                                                setConsumablesKPI(updatedConsumablesKPI);
                                                                }} 
                                                                placeholder="Details" 
                                                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
