...
export default function users() {
    ...
    const [items, setItems] = useState([{ name: '', itemqty:'', eachprice:'', condition:'', details: [{ type: '', details: '' }] }]);
    ...
    const handleDetailChange = (itemIndex, detailIndex, key, value) => {
      const newItems = [...items];
      newItems[itemIndex].details[detailIndex][key] = value;
      setItems(newItems);
    };
  
    const addItem = () => {
      setItems([...items, { name: '', itemqty:'', eachprice:'', condition:'', details: [{ type: '', details: '' }] }]);
    };
  
    const addDetail = (itemIndex) => {
      const newItems = [...items];
      newItems[itemIndex].details.push({ type: '', details: '' });
      setItems(newItems);
      console.log(items);
    };

    // selected period from create form
    ...
    const renderFile = (file, index) => {
      ...
      if (fileType === 'image') {
        ...
        if (file.type.includes('pdf')) {
          ...
          icon = <i className="fa fa-file-word-o" aria-hidden="true"></i>; // Example Word icon
        } else {
                        ...
                        {isOpenAddForm && (
                            <div className="fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center" style={{ marginLeft:0 }}>
                                ...
                                <div className="bg-white w-4/5 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                    ...
                                    {/* Modal body */}
                                    <form className="px-2 pt-2 overflow-y-scroll h-[500px]" style={{ scrollbarWidth: 'thin'}} onSubmit={submitForm} encType="multipart/form-data">
                                        {usercreateerror &&
                                        ...
                                        <div className="grid gap-6 md:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="mb-6">
                                                    ...
                                                    {/* Dropdown menu */}
                                                    <div data-collapse={isOpenOrganizationStructure} ref={refOrganizationStructure}>
                                                        <div
                                                            id="dropdownSearch"
                                                            className="z-10 hidden absolute bg-white border border-gray-200 rounded-lg shadow dark:bg-[#1e1e1e] rolelist w-[37.5%] mr-2"
                                                        >
                                        ...
                                        <div className="grid gap-6 mb-6">
                                            <div className="container mx-auto">
                                                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Items List</label>
                                                <div className='overflow-x-auto border border-gray-200 sm:rounded-lg w-[-webkit-fill-available]'>
                                                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th className="px-6 py-3">Item Qty</th>
                                                            <th className="px-6 py-3">Each price</th>
                                                        ...
                                                        {items.map((item, index) => (
                                                            <tr key={index} className='className="odd:bg-white odd:dark:bg-[#1e1e1e] even:bg-gray-50 even:dark:bg-[#3c4042] border-b dark:border-gray-700"'>
                                                            <td className="px-6 py-4">{item.name}</td>
                                                            <td className="px-6 py-4">{item.itemqty}</td>
                                                            <td className="px-6 py-4">{item.eachprice}</td>
                                                            <td className="px-6 py-4">{item.condition}</td>
                                                            <td className="px-6 py-4">
                                                                {item.details.map((detail, detailIndex) => (
                                                                <div key={detailIndex}>
                                                                    <p>{detail.type}: {detail.details}</p>
                                                                </div>
                                                                ))}
                                                            </td>
                                                            </tr>
                                                    ...
                                                    <div key={itemIndex} className="mb-4">
                                                        <div className='grid gap-6 mb-6 md:grid-cols-2'>
                                                            ...
                                                            <input
                                                                type="text"
                                                                value={item.itemqty}
                                                                onChange={(e) => handleChange(itemIndex, 'itemqty', e.target.value)}
                                                                placeholder="how meny qty you want?"
                                                                className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                            />
                                                            <input
                                                                type="text"
                                                                value={item.eachprice}
                                                                onChange={(e) => handleChange(itemIndex, 'eachprice', e.target.value)}
                                                                placeholder="Enter each item price"
                                                                className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                            />
                                                                ...
                                                                onChange={(e) => handleChange(itemIndex, 'condition', e.target.value)}
                                                                >
                                                                    <option selected="">Choose a expected condition</option>
                                                        ...
                                                        {item.details.map((detail, detailIndex) => (
                                                            <div key={detailIndex} className="grid gap-6 mb-6 md:grid-cols-2 w-[75%]">
                                                            <input
                                                                type="text"
                                                                value={detail.type}
                                                                onChange={(e) => handleDetailChange(itemIndex, detailIndex, 'type', e.target.value)}
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) => handleDetailChange(itemIndex, detailIndex, 'details', e.target.value)}
                                                                placeholder="Detail"
                                                                className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                            />
                                                            </div>
                                                        ))}
                                                    <button type='button' onClick={() => addDetail(itemIndex)} className="bg-blue-500 text-white px-4 py-2 rounded">
                                                        Add Detail
                                                    </button>
                                                    </div>
                                                ))}
                                        ...
                                        <div className="grid gap-6 md:grid-cols-2">
                                                ...
                                                {selectedOption === 'long' || selectedOption === 'short' ? (
                                        ...
                                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                                            <div>
                                                ...
                                                <input
                                                    className="block w-full text-lg text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-white dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                                    id="multiple_files"
                                                    type="file"
                                                    multiple
                                                ...
                                                />
                                                {files.length > 0 && (
                                                <div className='grid gap-6 mb-6 md:grid-cols-4 bg-white border border-gray-300 rounded-lg w-full p-2.5 dark:bg-[#3c4042] dark:border-gray-500 mt-10'>
