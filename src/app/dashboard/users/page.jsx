        ...
        <div className="p-4 pl-8 border-gray-200 rounded-lg subcontent dark:border-gray-700 mt-10">
            ...
            {formemessage &&
                <div className='flex justify-end w-[100%] fixed'>
                    ...
                    >
                        ...
                        <button type="button" onClick={handleClose} className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-red-400 hover:text-white ms-auto dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="crud-modal">
                ...
                <div className="w-full w-[-webkit-fill-available]">
                    ...
                    <div className="overflow-hidden bg-gray-50 sm:rounded-lg dark:bg-[#121212]">
                        ...
                        <div className="flex-row items-center justify-between py-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                            ...
                            {/* Modal */}
                            {isOpenAddForm && (
                                <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full" style={{ marginLeft: 0 }}>
                                    ...
                                    <div className="bg-white w-3/4 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                        <div className="flex items-center justify-between rounded-t dark:border-gray-600">
                                            <button type="button" onClick={closeAddFormModal} className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-red-400 hover:text-white ms-auto dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="crud-modal">
                                        ...
                                        <form className="px-2 pt-2" onSubmit={submitForm} encType="multipart/form-data">
                                            {usercreateerror &&
                                                <div className="relative px-4 py-3 mb-2 text-red-700 bg-red-100 border border-red-400 rounded" role="alert">
                                            ...
                                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div data-collapse={isOpenRoleList} ref={refRoleList}>
                                                        <div
                                                            id="dropdownSearch"
                                                            className="absolute z-10 hidden bg-white rounded-lg shadow w-60 dark:bg-gray-700 rolelist"
                                                        >
                                                            <div className="p-3">
            ...
            {view === 'list' ?
                                        ...
                                        <td className="px-2 py-4">
                                            <div className='flex justify-between w-auto'>
                                                ...
                                                {thisuserpermissionArray.includes('user password reset') && (
                                                    ...
                                                    >
                                                        <RiLockPasswordLine className='text-2xl text-gray-700 dark:text-white' />
                                                    </a>
                                                )}
                                                ...
                                                {expandedResetpasswordModel === Users.id && (
                                                    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full" style={{ marginLeft: 0 }}>
                                                        ...
                                                        <div className="bg-white w-1/2 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                                            <div className="flex items-center justify-between rounded-t dark:border-gray-600">
                                                                <button type="button" onClick={closeResetpasswordModel} className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-red-400 hover:text-white ms-auto dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="crud-modal">
                                                                    <IoClose className='text-2xl hover:text-white' />
                                                                    <span className="sr-only">Close modal</span>
                                                                </button>
                                                            </div>
                                                ...
                                                {expandedEditeRoleModel === Users.id && (
                                                    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full" style={{ marginLeft: 0 }}>
                                                        ...
                                                        <div className="bg-white w-3/4 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                                            <div className="flex items-center justify-between rounded-t dark:border-gray-600">
                                                                <button type="button" onClick={closeEditeRoleModel} className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-red-400 hover:text-white ms-auto dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="crud-modal">
                                                                    <IoClose className='text-2xl hover:text-white' />
                                                                    <span className="sr-only">Close modal</span>
                                                                </button>
                                                            </div>
                                                ...
                                                {expandedDeleteRoleModel === Users.id && (
                                                    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full" style={{ marginLeft: 0 }}>
                                                        ...
                                                        <div className="bg-white w-1/2 p-4 rounded-lg z-50 dark:bg-[#1e1e1e]">
                                                            <div className="flex items-center justify-between rounded-t dark:border-gray-600">
                                                                <button type="button" onClick={closeDeleteRoleModel} className="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg hover:bg-red-400 hover:text-white ms-auto dark:hover:bg-red-400 dark:hover:text-white" data-modal-toggle="crud-modal">
                                                                    <IoClose className='text-2xl hover:text-white' />
                                                                    <span className="sr-only">Close modal</span>
                                                                </button>
                                                            </div>
                                ...
                                {[...Array(Math.ceil(filteredUsers.length / itemsPerPage))].map((_, index) => (
                                    <li>
                                        <button
                                            ...
                                            className={`flex items-center justify-center px-3 h-8 border border-gray-300 dark:border-gray-700 dark:text-white ${currentPage === index + 1 ? 'bg-gray-200 text-blue-700 dark:bg-[#3c4042]' : 'bg-blue-50 text-blue-600 dark:bg-[#606368]'
                                                }`}
                                        >
                                            {index + 1}
                                        </button>
                ...
                <div className='flex flex-col'>
                    ...
                    {/* Pagination */}
                    datadata<div className='flex w-[-webkit-fill-available] justify-end'>
                        <nav aria-label="Page navigation example" className="flex justify-end">
                            <ul className="inline-flex -space-x-px text-sm">
                                <li>
                                    <button
