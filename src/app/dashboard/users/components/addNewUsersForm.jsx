...
function AddNewUsersForm({ }) {
    ...
    const submitForm = async e => {
        e.preventDefault();
        try {
            const user = { user_name: user_name, email: email, name: name, contact_no: contact_no, profile_image: profileImage, address: address, roles: selectedValues, user_description: user_description }
            addNewUser(user)
                .unwrap()
                .then((response) => {
