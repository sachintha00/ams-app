...
import WidgetSearchBox from "./widgetSearchBox";
    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="text-gray-400 bg-transparent hover:text-black-800 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center hover:bg-red-400 dark:bg-[#3c4042] dark:hover:bg-red-400"
