...
const menuItems = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { id: 52, title: "Add New Product", path: "#" },
    ],
  },
  {
    id: 7,
            ...
            <div className={`${collapsed ? "" : "mainnavlink"}`}>
              <li className="navlink" onClick={() => handleMenuClick(id)}>
                <span
                  className={`${
                    collapsed ? "" : "hoverspan"
                  } hidden flex absolute ml-5 w-24 bg-[#fff] text-gray-900 rounded-lg dark:text-white bg-gray-50 dark:bg-[#121212]`}
                >
                  {name}
                </span>
                <Link
                  ...
                  <ul>
                    {subMenu.map(({ id, title, path, subMenu }) => (
                      <div>
                        <span
                          className={`${
                            collapsed ? "" : "hoverspansub"
                          } hidden flex absolute ml-5 w-24 bg-[#fff] text-gray-900 rounded-lg dark:text-white bg-gray-50 dark:bg-[#121212]`}
                        >
                          {name}
                        </span>
                        <li
                          className={`${collapsed ? "subnavlink" : "hidden"}`}
                          key={id}
