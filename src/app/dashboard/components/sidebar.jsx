            ...
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                    ...
                    <span className={`${collapsed ? 'hidden' : ''} ${hoveredItem === 'Dashboard' ? 'block' : 'hidden'} shadow flex absolute ml-6 p-2.5 text-gray-900 rounded-lg dark:text-white bg-gray-50 dark:bg-[#3c4042] w-40`}>Dashboard</span>
                </Link>
              </li>
              ...
              {menuItems.map(sidebaritem => (
                <li key={sidebaritem.id} onClick={() => handleMenuItemClick(sidebaritem.id)} onMouseEnter={() => setHoveredItem(sidebaritem.MenuName)} onMouseLeave={() => setHoveredItem(null)} className={`${collapsed ? '' : 'flex'}`}>
                  ...
                  <Link
                    href={sidebaritem.MenuLink}>
                        <span className={`${collapsed ? 'hidden' : ''} ${hoveredItem === sidebaritem.MenuName ? 'block' : 'hidden'} flex shadow absolute p-2.5 text-gray-900 rounded-lg dark:text-white bg-gray-50 dark:bg-[#3c4042] w-44 justify-between items-center`}
                  ...
                  {sidebaritem.children && (
                    <ul id="dropdown-example" className={`${collapsed ? 'hidden' : 'block'} ${hoveredItem === sidebaritem.MenuName ? 'block' : 'hidden'} shadow absolute p-2.5 text-gray-900 rounded-lg dark:text-white bg-gray-50 dark:bg-[#3c4042] w-44 justify-between items-center ml-12 mt-10`}>
