...
function HeaderListView({ component: Component, data = [] }) {
  return (
    <div className="flex flex-col items-center justify-center my-5 rounded-md bg-gray-50 dark:bg-[#1e1e1e] tablelist">
      <div className="w-full overflow-x-auto border border-gray-200 sm:rounded-md">
        <Component data={data} />
      </div>
      {/* Pagination */}
