...
const Navbar = ({ onToggleSidebar }) => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
          ...
          if (refApp.current && !refApp.current.contains(event.target)) {
            setIsOpenAppMenu(false);
          }
    ...
    const toggleNotificationMenuHandler = () =>{
        setIsOpenNotificationMenu((prev) => !prev);
        setIsOpenAppMenu(false);
        setIsOpenUserMenu(false);
    };

    const toggleAppMenuHandler = () =>{
        setIsOpenAppMenu((prev) => !prev);
        setIsOpenUserMenu(false);
        setIsOpenNotificationMenu(false);
    };
    ...
    return (
        <nav className="bg-white border-gray-200 px-4 lg:px-6 dark:bg-[#1e1e1e]">
            ...
            <div className="flex items-center lg:order-2 w-96 justify-end">
                ...
                <svg
                    aria-hidden="true"
                    className="mr-1 -ml-1 w-5 h-5 text-white"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                >
                ...
                */}
                ...
                aria-expanded="false"
                onClick={toggleNotificationMenuHandler}
                >
                ...
                {/* Dropdown menu */}
                <div data-collapse={isOpenNotificationMenu} ref={refNotification} className='absolute mainnotificationsdiv'>
                    <div
                ...
                {/* Dropdown menu */}
                <div data-collapse={isOpenAppMenu} ref={refApp} className='absolute mainappdiv'>
                    <div
                ...
                <div data-collapse={isOpenUserMenu} ref={refUser} className='absolute maindivusermenu'>
                    <div
                    className="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-[#3c4042] dark:divide-gray-600 usermenu"
                    id="dropdown"
                    >
