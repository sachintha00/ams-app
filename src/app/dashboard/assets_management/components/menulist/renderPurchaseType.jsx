const renderPurchaseType = (PurchaseType, selected) => (
    <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:bg-[#3c4042]">
        ...
        {selected && selected.availability_type_id === PurchaseType.availability_type_id && (
            <svg
...
export default renderPurchaseType;