const renderAssetSubCategories = (assetSubCategories, selected) => (
    <div className="flex items-center p-2 rounded hover:bg-gray-100 dark:bg-[#3c4042]">
        <label className="w-full text-sm font-medium text-gray-900 dark:text-gray-300">
            {assetSubCategories.assc_name}
        </label>
        {selected && selected.assc_id === assetSubCategories.assc_id && (
            <svg
...
export default renderAssetSubCategories;