...
} from "@/app/_lib/redux/features/supplier/supplier_api";
        ...
        <div>
            <Formik
                ...
                onSubmit={async (values, { resetForm }) => {
                    ...
                    try {
                        await removeSupplier(id).unwrap();
                        dispatch(handleClosePopupModel());
                        console.log("supllier  deleted successfully");
                    } catch (error) {
...
export default RemoveSupplierForm;
