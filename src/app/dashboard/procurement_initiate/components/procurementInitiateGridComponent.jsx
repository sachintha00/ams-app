...
function ProcurementInitiateGridComponent({
                    ...
                    <div className="w-full my-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-[#1e1e1e] dark:border-gray-700">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between">
                                <div className="w-[60%]">
                                    <h5 className="mb-4 text-black text-xl font-medium leading-tight dark:text-white">
                                        Received Quotation
                                    </h5>
                                </div>
                                {/* <div className="w-[15%]">
                            ...
                            <div className="flex justify-end">
                                ...
                                {procurement.procurement_status === 'save' ? (
                                    <p className="flex items-center text-green-500 mb-4"><TbPhoneCalling className="text-green-500 text-[20px] mr-1"/>Quotation Calling To Supplier</p>
                                )
                                :
                                (
                                    <a
...
export default ProcurementInitiateGridComponent;