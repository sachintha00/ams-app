              ...
              <div className="flex min-h-full flex-1 flex-col justify-center px-6 lg:px-8">
                  ...
                  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                      <form class="max-w-sm mx-auto" onSubmit={submitForm}>
                        ...
                        <button type="submit" class="w-full text-white bg-[#213389] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-[#213389] dark:focus:ring-blue-800">Submit</button>
                      </form>
                  </div>
              </div>
            </div>
